...
const NoHistory = () => (
  <div style={{ display: "flex", flexDirection: "column" }}>
    ...
    <p>
      After accessing an account in the search module, it will be logged here
      for easy access to recent accounts you've worked with.
    </p>
  </div>
);
    ...
    <React.Fragment>
      {dev ? (
        <React.Fragment>
          ...
          <p>
            {" "}
            History data is not live and some functionality may be disabled.
          </p>
        </React.Fragment>
      ) : null}
